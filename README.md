...
## Examples
The `examples` directory contains source code for producing the images of the README. For instance, `examples/visualize_functions.rs` is executed by the following command:
